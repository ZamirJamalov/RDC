...
type ServiceHealth struct {
	...
	// PR #509: son uğursuz çağırışın müraciət ID-si (ancaq rəqəmli ID) —
	// admin paneldə "✗ vaxt · №123" kimi göstərilir (fail hansı müraciətdidir).
	LastFailureAppID *int `json:"last_failure_app_id,omitempty"`
