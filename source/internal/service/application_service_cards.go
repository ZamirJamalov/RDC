...
//   - Köhnə kart seçilərsə confirm-də selected_card_id göndərilir. PR #347:
//     RegisterCard yenə də çağırılır (AZMK-dan gələn maskalı kodla); xəta
//     olsa seçilmiş card_id fallback kimi yazılır, disburse onunla gedir.
//
