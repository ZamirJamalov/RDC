...
func TestCreateApplication_Validation(t *testing.T) {
        ...
        for _, tc := range tests {
                t.Run(tc.name, func(t *testing.T) {
                        svc := NewApplicationService(newMockStore(), NewCreditEngine(newMockLWProvider(), newMockStore()))
...
func TestCreateApplication_DuplicatePending(t *testing.T) {
        ...
        svc := NewApplicationService(store, NewCreditEngine(newMockLWProvider(), newMockStore()))
...
func TestCreateApplication_PreValidateFails(t *testing.T) {
        ...
        svc := NewApplicationService(store, NewCreditEngine(newMockLWProvider(), store))
...
func TestCreateApplication_Success(t *testing.T) {
        ...
        svc := NewApplicationService(store, engine)
