...
type offerRequest struct {
	...
	CustomerSerial string `json:"customer_serial"` // PR #379: AZMK inquireByIdCard serial tələb edir
...
func (h *ApplicationHandler) GetOffer(w http.ResponseWriter, r *http.Request) {
	...
	offer, err := h.service.GetOffer(r.Context(), req.CustomerPIN, req.CustomerSerial, req.AKBScore)
